<html>
    ...
    <body>
        ...
        <?php
        $id2 = $_GET['buscar'];
        $resultado = mysqli_query($conexion,"select * from Libro where Descripcion like '%$id2%' or Descripcion like '%$id2%' or Descripcion like '%$id2' or Nombre like '%{$id2}%' or Nombre like '$id2%' or Nombre like '%$id2';");
